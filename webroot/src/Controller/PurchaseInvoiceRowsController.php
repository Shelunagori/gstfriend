...
class PurchaseInvoiceRowsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['CgstLedgers', 'SgstLedgers', 'PurchaseInvoices']
        ];
    ...
    public function add()
    {
        ...
        $cgstLedgers = $this->PurchaseInvoiceRows->CgstLedgers->find('list', ['limit' => 200]);
        $sgstLedgers = $this->PurchaseInvoiceRows->SgstLedgers->find('list', ['limit' => 200]);
        $purchaseInvoices = $this->PurchaseInvoiceRows->PurchaseInvoices->find('list', ['limit' => 200]);
        $this->set(compact('purchaseInvoiceRow', 'cgstLedgers', 'sgstLedgers', 'purchaseInvoices'));
        $this->set('_serialize', ['purchaseInvoiceRow']);
    }
