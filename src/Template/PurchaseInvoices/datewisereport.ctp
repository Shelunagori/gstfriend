<table class=" table table-bordered table-hover" id='main_tbl' >
	...
	<tbody>
		...
		<tr>
			...
			<td style="text-align:right"><?= $this->Number->format($reportdata->base_amount) ?></td>
			<td style="text-align:right"><?= $this->Number->format($reportdata->cgst) ?></td>
			<td style="text-align:right"><?= $this->Number->format($reportdata->sgst) ?></td>
			<td style="text-align:right"><?= $this->Number->format($reportdata->total) ?></td>
		</tr>
		<?php endforeach;  ?>
	</tbody>
	<tfoot>
