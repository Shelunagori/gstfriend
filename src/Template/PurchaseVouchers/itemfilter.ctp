<div  class="main_div maindiv" style="border:none">
	<?php echo $this->Html->link( '<i class="fa fa-file-excel-o"></i> Excel', '/PurchaseVouchers/Item-Wise-Excel/'.$itemwise.'',['class' =>'btn btn-sm green tooltips pull-right Item-Wise-Excel','target'=>'_blank','escape'=>false,'data-original-title'=>'Download as excel']); ?>
